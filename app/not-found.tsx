        ...
        <main className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden px-6 text-center">
            ...
            <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
                <div
                    ...
                    style={{
                        background: 'radial-gradient(circle at 50% 40%, rgba(160,120,245,0.06) 0%, transparent 60%)',
                    }}
                />
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center max-w-2xl mx-auto mt-[-5vh]">
                ...
                <OutlineButton
                    href="/"
                    icon={<HiArrowLongLeft className="w-5 h-5 group-hover:text-white transition-colors" />}
                >
                    Back to Homepage
                </OutlineButton>
            </div>
